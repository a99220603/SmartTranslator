...
[![Version](https://img.shields.io/badge/version-2.3.6-blue.svg)](https://github.com/a99220603/SmartTranslator)
...
### 🌐 多人遊戲支援 (v2.3.5 新增)
- **完整相容性**：修復多人遊戲環境下的兼容性問題
- **客戶端/服務端分離**：正確區分客戶端和服務端代碼執行
- **穩定連接**：解決專用服務器環境下的崩潰問題
- **無縫體驗**：單人和多人模式下功能完全一致
...
### 安裝步驟
1. 下載最新版本的 `smarttranslator-2.3.6.jar`
...
### v2.3.5 (最新版本)
- 🔧 **多人遊戲修復**：解決多人遊戲環境下的兼容性問題
- 🌐 **服務端支援**：修復專用服務器環境下的崩潰問題
- ⚡ **穩定性提升**：改善客戶端/服務端代碼分離
- 🛡️ **錯誤處理**：增強異常處理機制
