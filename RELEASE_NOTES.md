# SmartTranslator v2.3.4 發布說明

## 🎨 顯示優化更新

SmartTranslator v2.3.4 專注於改善用戶界面體驗，優化 tooltip 顯示效果，提供更清晰、更統一的雙語顯示格式。

## 📦 構建信息
- **文件名**: smarttranslator-2.3.4.jar
- **文件大小**: 134,466 字節 (131 KB)
- **構建時間**: 2025年9月23日
- **Minecraft版本**: 1.21.4
- **NeoForge版本**: 21.4.154

## 🔧 技術改進
- 增強的緩存優化器 (EnhancedCacheOptimizer)
- 改進的翻譯性能和內存管理
- 優化的批量翻譯處理
- 更好的錯誤處理和日誌記錄
...
### 📏 Tooltip 顯示優化
- **擴大顯示寬度**：最大 tooltip 寬度從 25 增加到 50 字符
- **優化單行顯示**：單行最大寬度從 20 增加到 45 字符
- **智能截斷**：改進長文本顯示邏輯，提升可讀性

### 🎯 英文對照功能
- **預設顯示**：`SHOW_ORIGINAL_TEXT` 配置預設為 `true`
- **便於理解**：自動顯示英文原文對照
- **學習輔助**：幫助玩家學習英文物品名稱
...
- **移除視覺混淆**：統一雙語顯示格式
- **顏色處理改善**：避免文字重疊和顏色衝突
- **樣式簡化**：移除不必要的粗體格式，保持清晰度

## 📊 顯示效果對比

| 項目 | v2.0.0 | v2.3.4 | 改善效果 |
|------|--------|--------|----------|
| 最大顯示寬度 | 25 字符 | 50 字符 | **2倍提升** |
| 單行寬度 | 20 字符 | 45 字符 | **2.25倍提升** |
| 英文對照 | 可選 | 預設開啟 | **預設顯示** |
| 格式統一性 | 一般 | 優化 | **視覺清晰** |
